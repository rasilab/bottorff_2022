...
ggsave("../figures/nluc_fluc_ratio_vary_uorf2_d_stall.pdf")
```

# Conclusions

 - Varying the distance between the uORF2 elongation stall and its start codon (d_stall) doesn't change its repression of main ORF translation very much
 - The 10 eYFP codons longer uORF2 (longest d_stall) may be less repressive due to a weakened elongation stall, as we are inserting many bases into uORF2 and not just the terminus of uORF2 is important for its elongation stall