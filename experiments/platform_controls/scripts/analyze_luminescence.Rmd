...
# Plot average nluc/fluc ratios by reporter construct
 ggplot(aes(x = label, y = mean_ratio, ymax = mean_ratio + se_ratio,
  ...
  coord_flip() +
  theme_rasilab()
ggsave("../figures/nluc_fluc_ratio_ul4_control_mutants.pdf")
```

# Conclusions

 - WT UL4 5' UTR strongly represses main ORF translation
 - Removing the uORF2 start codon or stall (P22A mutation) abolishes UL4 5' UTR repressiveness
 - Improving uORF2's initiation (via an improved Kozak mutation) increases the repressiveness of the UL4 5' UTR
