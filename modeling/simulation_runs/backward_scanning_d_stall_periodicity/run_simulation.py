...
os.remove(xmlfile)
os.remove(rxnfile)
# have the os.remove() not hashtagged out when running on cluster (can have rxnfile and bnglfile removal hashtagged out when running just 1 simulation)
