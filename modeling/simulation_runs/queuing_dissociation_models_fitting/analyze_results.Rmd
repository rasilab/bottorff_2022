...
other_data <- read_csv("../80s_hit_model_fitting/tables/fit_params.csv") %>%
...
```{r,fig.width=5.5,fig.height=1,eval=F}
...
plot_data_controls %>%
  ...
  theme(axis.text.y = element_text(size = 8), axis.text.x = element_text(size = 8), axis.title.y=element_blank()) +
  labs(x = "main ORF protein\noutput (log2, s-1)", y = "Mutant")
  
  ggsave('figures/fig_2d.pdf')
```