---
title: "Analysis of computational simulations of control data in the queueing-mediated enhanced repression and collision-mediated 40S dissociation models"
...
# Read in 80S-hit control predcitions to make 1 plot with all 3 models
...
# Conclusions
 ...
 - parameters can be found such that computational modeling of the queueing-mediated enhanced repression and collision-mediated 40S dissociation models matches experimental control data from *UL4* uORF2
 1) recycling rate of 5/s
 2) cap binding rate of ~0.024/s
 3) 9, 50% uORF initiation in WT, stronger Kozak contexts