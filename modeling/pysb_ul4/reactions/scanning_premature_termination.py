...
def scan_terminate_no_hit(model, ssu, mrna, pos, tc, k):
...
def scan_terminate_5_hit_scanning(model, ssu, mrna, tc, pos, k):
...
def scan_terminate_5_hit_elongating(model, ssu, lsu, mrna, tc, pos, k):
...
def scan_terminate_3_hit_scanning(model, ssu, mrna, tc, pos, k):
...
def scan_terminate_3_hit_elongating(model, ssu, lsu, mrna, tc, pos, k):
...
def scan_terminate_both_hit_scanning_scanning(model, ssu, mrna, tc, pos, k):
...
def scan_terminate_both_hit_scanning_elongating(model, ssu, lsu, mrna, tc, pos, k):
...
def scan_terminate_both_hit_elongating_scanning(model, ssu, lsu, mrna, tc, pos, k):
...
def scan_terminate_both_hit_elongating_elongating(model, ssu, lsu, mrna, tc, pos, k):
