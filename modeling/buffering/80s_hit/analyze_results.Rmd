...
plot_data %>% 
  ...
  labs(x = "ribosome loading (log2, s-1)", y = "main ORF protein\noutput (log2, s-1)",
       color = "Baseline uORF\ninitiation (%)") + 
  #theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"), axis.title.x = element_text(size = 18), axis.text.y = element_text(size = 18), axis.text.x = element_text(size = 18), axis.title.y = element_text(size = 18), legend.text = element_text(size = 18), legend.title = element_text(size = 18), strip.text.x = element_text(size = 18))
...
# Conclusions
 ...
 - buffering is lost when parameters matched to experimental control data are used (uORF doesn't initiate well enough, continued scanning is too frequent, short uORF) whether or not an elongation stall is present
