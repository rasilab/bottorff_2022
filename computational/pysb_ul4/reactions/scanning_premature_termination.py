...
def scan_terminate_no_hit_tc_ejects(model, ssu, mrna, pos, tc, k):
	...
	sb.Rule(f'scan_terminate_no_hit_tc_ejects_{pos}',
...
def scan_terminate_no_hit(model, ssu, mrna, pos, k):
	...
	ssu_reactant_args = {'asite': 1, 'hit5': None, 'hit3': None, 'isbi': None, 'tcsite': None}
	ssu_product_args = {'asite': None, 'hit5': None, 'hit3': None, 'isbi': None, 'tcsite': None}
...
def scan_terminate_5_hit_scanning_tc_ejects(model, ssu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_scan_collision_5_hit_tc_ejects_{pos}',
...
def scan_terminate_5_hit_scanning(model, ssu, mrna, pos, k):
	...
	mrna_reactant_args = {f'nt{pos}': 1, f'nt{pos - model.l_ssu}': 2}
	mrna_product_args = {f'nt{pos}': None, f'nt{pos - model.l_ssu}': 2}
	ssu_reactant_args = {'asite': 1, 'hit5': 3, 'hit3': None, 'isbi': None, 'tcsite': None}
	ssu_product_args = {'asite': None, 'hit5': None, 'hit3': None, 'isbi': None, 'tcsite': None}
	trailing_ssu_reactant_args = {'asite': 2, 'hit3': 3, 'isbi': None}
	trailing_ssu_product_args = {'asite': 2, 'hit3': None, 'isbi': None}
...
def scan_terminate_5_hit_elongating_tc_ejects(model, ssu, lsu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_elongation_collision_5_hit_tc_ejects_{pos}',
...
def scan_terminate_5_hit_elongating(model, ssu, lsu, mrna, pos, k):
	...
	sb.Rule(f'scan_terminate_from_elongation_collision_5_hit_{pos}',
			...
			ssu(**ssu_product_args) + ssu(**trailing_ssu_product_args) % lsu(**trailing_lsu_product_args) % mrna(**mrna_product_args),
			k)

def scan_terminate_3_hit_scanning_tc_ejects(model, ssu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_scan_collision_3_hit_tc_ejects_{pos}',
...
def scan_terminate_3_hit_scanning(model, ssu, mrna, pos, k):
	...
	mrna_reactant_args = {f'nt{pos}': 1, f'nt{pos + model.l_ssu}': 2}
	mrna_product_args = {f'nt{pos}': None, f'nt{pos + model.l_ssu}': 2}
	ssu_reactant_args = {'asite': 1, 'hit5': None, 'hit3': 3, 'isbi': None, 'tcsite': None}
	ssu_product_args = {'asite': None, 'hit5': None, 'hit3': None, 'isbi': None, 'tcsite': None}
	leading_ssu_reactant_args = {'asite': 2, 'hit5': 3, 'isbi': None}
	leading_ssu_product_args = {'asite': 2, 'hit5': None, 'isbi': None}
...
def scan_terminate_3_hit_elongating_tc_ejects(model, ssu, lsu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_elongation_collision_3_hit_tc_ejects_{pos}',
...
def scan_terminate_3_hit_elongating(model, ssu, lsu, mrna, pos, k):
	...
	sb.Rule(f'scan_terminate_from_elongation_collision_3_hit_{pos}',
			ssu(**ssu_reactant_args) % ssu(**leading_ssu_reactant_args) % lsu(**leading_lsu_reactant_args) % mrna(**mrna_reactant_args) >>
			ssu(**ssu_product_args) + ssu(**leading_ssu_product_args) % lsu(**leading_lsu_product_args) % mrna(**mrna_product_args),
			k)

def scan_terminate_both_hit_scanning_scanning_tc_ejects(model, ssu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_scanning_scanning_tc_ejects_{pos}',
...
def scan_terminate_both_hit_scanning_scanning(model, ssu, mrna, pos, k):
	...
	mrna_product_args = {
		f'nt{pos}': None, f'nt{pos + model.l_ssu}': 2, f'nt{pos - model.l_ssu}': 3}
	ssu_reactant_args = {'asite': 1, 'hit5': 4, 'hit3': 5, 'isbi': None, 'tcsite': None}
	ssu_product_args = {'asite': None, 'hit5': None, 'hit3': None, 'isbi': None, 'tcsite': None}
	leading_ssu_reactant_args = {'asite': 2, 'hit5': 5, 'isbi': None}
	leading_ssu_product_args = {'asite': 2, 'hit5': None, 'isbi': None}
	trailing_ssu_reactant_args = {'asite': 3, 'hit3': 4, 'isbi': None}
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_scanning_scanning_{pos}',
			ssu(**ssu_reactant_args) % ssu(**leading_ssu_reactant_args) % ssu(**trailing_ssu_reactant_args) % mrna(**mrna_reactant_args) >>
			ssu(**ssu_product_args) + ssu(**leading_ssu_product_args) % ssu(**trailing_ssu_product_args) % mrna(**mrna_product_args),
			k)

def scan_terminate_both_hit_scanning_elongating_tc_ejects(model, ssu, lsu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_scanning_elongating_tc_ejects_{pos}',
			...
			ssu(**ssu_product_args) + tc(**tc_product_args) + ssu(**leading_ssu_product_args) % lsu(**leading_lsu_product_args) % ssu(**trailing_ssu_product_args) % mrna(**mrna_product_args),
			k)
...
def scan_terminate_both_hit_scanning_elongating(model, ssu, lsu, mrna, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_scanning_elongating_{pos}',
			ssu(**ssu_reactant_args) % ssu(**leading_ssu_reactant_args) % lsu(**leading_lsu_reactant_args) % ssu(**trailing_ssu_reactant_args) % mrna(**mrna_reactant_args) >>
			ssu(**ssu_product_args) + ssu(**leading_ssu_product_args) % lsu(**leading_lsu_product_args) % ssu(**trailing_ssu_product_args) % mrna(**mrna_product_args),
			k)

def scan_terminate_both_hit_elongating_scanning_tc_ejects(model, ssu, lsu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_elongating_scanning_tc_ejects_{pos}',
...
def scan_terminate_both_hit_elongating_scanning(model, ssu, lsu, mrna, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_elongating_scanning_{pos}',
			ssu(**ssu_reactant_args) % ssu(**leading_ssu_reactant_args) % lsu(**trailing_lsu_reactant_args) % ssu(**trailing_ssu_reactant_args) % mrna(**mrna_reactant_args) >>
			ssu(**ssu_product_args) + ssu(**leading_ssu_product_args) % lsu(**trailing_lsu_product_args) % ssu(**trailing_ssu_product_args) % mrna(**mrna_product_args),
			k)

def scan_terminate_both_hit_elongating_elongating_tc_ejects(model, ssu, lsu, mrna, tc, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_elongating_elongating_tc_ejects_{pos}',
...
def scan_terminate_both_hit_elongating_elongating(model, ssu, lsu, mrna, pos, k):
	...
	sb.Rule(f'scan_terminate_from_collision_both_hit_elongating_elongating_{pos}',
			ssu(**ssu_reactant_args) % ssu(**leading_ssu_reactant_args) % lsu(**leading_lsu_reactant_args) % ssu(**trailing_ssu_reactant_args) % lsu(**trailing_lsu_reactant_args) % mrna(**mrna_reactant_args) >>
			ssu(**ssu_product_args) + ssu(**leading_ssu_product_args) % lsu(**leading_lsu_product_args) % ssu(**trailing_ssu_product_args) % lsu(**trailing_lsu_product_args) % mrna(**mrna_product_args),
			k)